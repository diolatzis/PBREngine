...
int main()
{
	...
	engine.addRenderableGameObject(glm::vec3(-7.0f, 2.5f, -7.0f), Mesh::MESH_TYPE_TRIANGULAR, "../meshes/hypnos.obj", "../textures/marble.png", 894, 894);
	...
	engine.addRenderableGameObject(glm::vec3(0.2f, 2.2f, -7.0f), Mesh::MESH_TYPE_TRIANGULAR, "../meshes/grace.obj", "../textures/marble.png", 894, 894);
	engine.addRenderableGameObject(glm::vec3(7.0f, -0.2f, -7.1f), Mesh::MESH_TYPE_TRIANGULAR, "../meshes/base.obj", "../textures/marble.png", 894, 894);
	engine.addRenderableGameObject(glm::vec3(7.0f, 2.0f, -7.0f), Mesh::MESH_TYPE_TRIANGULAR, "../meshes/helios.obj", "../textures/marble.png", 894, 894);
